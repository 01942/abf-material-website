    ...
    <main className="flex min-h-screen flex-col items-center">
      ...
      <section className="w-full py-24 px-8 bg-secondary/5">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[400px] bg-card rounded-2xl overflow-hidden shadow-2xl border border-border group cursor-pointer">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            ...
            {/* Absolute Link Overlay for guaranteed clickability */}
            <Link href="/about" className="absolute inset-0 z-20" aria-label="了解更多关于我们" />
          </div>
        </div>
      </section>
