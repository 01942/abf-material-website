  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      ...
      <section className="relative w-full h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20" style={{ backgroundImage: "url('/images/doc/hero_film_roll.png')", backgroundSize: 'cover', backgroundPosition: 'center' }} />
      ...
      <section className="w-full py-24 px-8 bg-secondary/5">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[500px] bg-card rounded-2xl overflow-hidden shadow-2xl border border-border">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/doc/rd_lab_env.png" alt="R&D Lab" className="absolute inset-0 w-full h-full object-cover" />
