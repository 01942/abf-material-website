                ...
                <div className="space-y-24 mt-16 border-t border-border pt-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div className="order-2 md:order-1 grid grid-cols-2 gap-4">
                            <div className="relative h-48 md:h-64 bg-card rounded-2xl overflow-hidden shadow-lg border border-border mt-8">
                                {/* eslint-disable-next-line @next/next/no-img-element */}
                                <img src="/images/doc/real_mfg_room.jpg" alt="Manufacturing Workshop" className="absolute inset-0 w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                            </div>
                            <div className="relative h-48 md:h-64 bg-card rounded-2xl overflow-hidden shadow-lg border border-border">
                                {/* eslint-disable-next-line @next/next/no-img-element */}
                                <img src="/images/doc/real_mfg_machine.jpg" alt="Coating Machine Detail" className="absolute inset-0 w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                            </div>
                        </div>
